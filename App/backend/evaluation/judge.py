...
# LLM Judge
# ---------------------------------------------------------
# Evaluates the generated answer using an LLM.
# ---------------------------------------------------------
# """
...
# from backend.evaluation.prompts import SYSTEM_PROMPT, EVALUATION_PROMPT
# #from backend.evaluation.judge_client import judge_llm
# from backend.app_logs.logger import logger
# from backend.llm_client import client
...
#     # remove <think> blocks (IMPORTANT FIX)
#     text = re.sub(r"<think>.*?</think>", "", text, flags=re.DOTALL)
...
# def evaluate_answer(question, context, generated_answer, golden_answer):
